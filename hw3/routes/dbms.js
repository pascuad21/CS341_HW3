...
var host = "35.233.179.169";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "#Ilikecheesecake";  //password (change to match your db, yes this is very poor practice)
